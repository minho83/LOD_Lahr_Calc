...
(function(window) {
    ...
    // ========================================
    // 
    // 새 공식: 1회 업그레이드 경험치 = [f(next) - f(current)] * (기준증가량 / 실제증가량)
    // HP 기준증가량 = 50
    // 
    // 최적화: 각 티어 내에서 수학적으로 한 번에 계산
    // 티어 내 총 경험치 = [f(end) - f(start)] * (기준증가량 / 실제증가량)
    //
    ...
    // 경험치로 단수 계산
    // ========================================
    // dansuTable은 외부에서 주입 (index.html에 정의됨)
